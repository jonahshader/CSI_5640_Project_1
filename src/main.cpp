...
int main(int argc, char *argv[])
{
    ...
    ca::World world;
    world.width = SCREEN_WIDTH / CELL_SIZE;
    world.height = SCREEN_HEIGHT / CELL_SIZE;
    world.state = new ca::cell_t[world.width * world.height];
    ...
    {
        world.state[i] = dis(gen);
    }

    // render the state
    ca::render_state(world, renderer, window);
